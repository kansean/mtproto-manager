...
│   │   └── traffic.py      # Мониторинг трафика: агрегированный + per-user
...
- **Dashboard** — агрегированный статус прокси ("Running 2/3"), диапазон портов, количество пользователей, трафик (агрегированный + таблица по пользователям), управление запуском
- **Users** — список пользователей с ключами, портами, трафиком, ссылками `t.me/proxy`, QR-кодами
