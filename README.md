...
- **SNI-домен** — в режиме Port 443 можно сменить домен: выбрать из пула (30 доменов, включая российские: `vk.com`, `ya.ru`, `mail.ru`, `gosuslugi.ru` и др.) или ввести любой кастомный домен. Смена домена перегенерирует секрет и перезапустит прокси — нужно будет отправить новую ссылку.
